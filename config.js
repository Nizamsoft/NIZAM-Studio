...
/* Tasarım durağı: "Görsel dünya" ve onun tasarım-tarifi sistemi (dil/renk/
   ...
   var/yok), (3) ekran kuralı: ekte hangi ekran varsa yalnız o çizilir
   (yalnız mobil geldiyse yalnız mobil). Müşteri beğendiğini
...
const TASARIM_YON = [
  { anahtar: 'marka', ad: 'Editoryal / Fotoğraflı', renk: '#c9753c',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü olduğu gibi koru, '
      + 'hiçbir öğeyi ekleme/çıkarma — yalnız görsel dili değiştir. '
      + 'Yön: bir dergi kapağı gibi editoryal bir kabuk. Başlıkları '
      ...
      + '**Ekte hangi ekran varsa yalnız onu çiz:** yalnız mobil ekran '
      + 'görüntüsü gönderdiysem yalnız mobil tasarım üret, yalnız '
      + 'masaüstü gönderdiysem yalnız masaüstü üret, ikisini birden '
      + 'gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir ekran '
      + 'türünü kendiliğinden ekleme, istenmedikçe ikinci bir versiyon '
      + 'üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      ...
      + 'üstte ince bir şerit yap, altına bölüm bağlantılarını diz. '
      + '**Ekte hangi ekran varsa yalnız onu çiz:** yalnız mobil ekran '
      + 'görüntüsü gönderdiysem yalnız mobil tasarım üret, yalnız '
      + 'masaüstü gönderdiysem yalnız masaüstü üret, ikisini birden '
      + 'gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir ekran '
      + 'türünü kendiliğinden ekleme, istenmedikçe ikinci bir versiyon '
      + 'üretme. Mobil çizeceksen masaüstünü daraltarak verme, mobil '
  ...
  { anahtar: 'minimal', ad: 'İsviçre Usulü / Sıfır Süs', renk: '#8fae4a',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü olduğu gibi koru, '
      + 'hiçbir öğeyi ekleme/çıkarma — yalnız görsel dili değiştir. '
      + 'Yön: katı İsviçre/Bauhaus usulü minimalizm. **Fotoğrafı '
      ...
      + 'gibi eşit. **Ekte hangi ekran varsa yalnız onu çiz:** yalnız '
      + 'mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım üret, '
      + 'yalnız masaüstü gönderdiysem yalnız masaüstü üret, ikisini '
      + 'birden gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir '
      + 'ekran türünü kendiliğinden ekleme, istenmedikçe ikinci bir '
      + 'versiyon üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      + 'bilgiler ve aynı işlevler kalsın, hiçbirini atma — ama düzen, '
      ...
      + 'dursun. **Ekte hangi ekran varsa yalnız onu çiz:** yalnız '
      + 'mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım üret, '
      + 'yalnız masaüstü gönderdiysem yalnız masaüstü üret, ikisini '
      + 'birden gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir '
      + 'ekran türünü kendiliğinden ekleme, istenmedikçe ikinci bir '
      + 'versiyon üretme. Mobil çizeceksen masaüstünü daraltarak verme, '
  ...
  { anahtar: 'sicak', ad: 'Yumuşak / Oyunbaz', renk: '#c4a05c',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü olduğu gibi koru, '
      + 'hiçbir öğeyi ekleme/çıkarma — yalnız görsel dili değiştir. '
      + 'Yön: yumuşak ve oyunbaz, **neumorfik (soft-UI)** bir his. Tek '
      ...
      + 'yuvarlak, hiçbir yerde keskin çizgi olmasın. **Ekte hangi '
      + 'ekran varsa yalnız onu çiz:** yalnız mobil ekran görüntüsü '
      + 'gönderdiysem yalnız mobil tasarım üret, yalnız masaüstü '
      + 'gönderdiysem yalnız masaüstü üret, ikisini birden gönderdiysem '
      + 'ikisini ayrı ayrı çiz. Ekte olmayan bir ekran türünü '
      + 'kendiliğinden ekleme, istenmedikçe ikinci bir versiyon üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      + 'bilgiler ve aynı işlevler kalsın, hiçbirini atma — ama düzen, '
      + 'hiyerarşi, ızgara, gezinme ve sayfa ritmi tamamen senin '
      ...
      + 'kalsın. **Ekte hangi ekran varsa yalnız onu çiz:** yalnız '
      + 'mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım üret, '
      + 'yalnız masaüstü gönderdiysem yalnız masaüstü üret, ikisini '
      + 'birden gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir '
      + 'ekran türünü kendiliğinden ekleme, istenmedikçe ikinci bir '
  ...
  { anahtar: 'kurumsal', ad: 'Kurumsal / Yoğun Panel', renk: '#6b7178',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü olduğu gibi koru, '
      + 'hiçbir öğeyi ekleme/çıkarma — yalnız görsel dili değiştir. '
      + 'Yön: ciddi bir kurumsal **yönetim paneli** (Bloomberg/ERP '
      ...
      + 'yuvarlak/samimi hiçbir öğe olmasın. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
      + 'istenmedikçe ikinci bir versiyon üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      + 'bilgiler ve aynı işlevler kalsın, hiçbirini atma — ama düzen, '
      + 'hiyerarşi, ızgara, gezinme ve sayfa ritmi tamamen senin '
      ...
      + 've toplam satırı altta sabit dursun. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
      + 'istenmedikçe ikinci bir versiyon üretme. Mobil çizeceksen '
  ...
  { anahtar: 'aurora', ad: 'Aurora / Yumuşak Degrade', renk: '#a259c4',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: çağdaş bir SaaS '
      + 'ürün sitesi — yumuşak aurora degradeleri. Zemin açık ve temiz; '
      + 'üstte geniş, bulanık, çok renkli bir ışık halesi (lavanta → '
      ...
      + 'köşe ya da doygun blok renk kullanma. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'şeritler hâlinde birbirini izlesin. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
  ...
  { anahtar: 'bento', ad: 'Bento / Mozaik Izgara', renk: '#4a7dd4',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: Apple\'ın '
      + 'tanıtım sayfalarındaki gibi bir **bento** dili. Zemin açık '
      + 'nötr gri; her kart beyaz ve **20-24px yuvarlak köşeli** bir '
      + 'döşeme olsun. Kenarlık kullanma — ayrımı yalnız zemin ile kart '
      + 'arasındaki ton farkı ve çok hafif, geniş yayılan bir gölge '
      + 'yapsın. Her döşemede tek bir fikir olsun ve o döşemenin en '
      + 'önemli sayısını devasa yaz (gövde yazısının 5-6 katı), '
      + 'etiketini küçük ve soluk bırak. Bazı döşemelere kendi hafif '
      + 'renk tonunu ver (buz mavisi, nane, şeftali) ama metin her '
      + 'yerde koyu nötr kalsın. Modern geometrik bir sans kullan, '
      ...
      + 'tertipli olsun. **Ekte hangi ekran varsa yalnız onu çiz:** '
      + 'yalnız mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım '
      + 'üret, yalnız masaüstü gönderdiysem yalnız masaüstü üret, '
      + 'ikisini birden gönderdiysem ikisini ayrı ayrı çiz. Ekte '
      + 'olmayan bir ekran türünü kendiliğinden ekleme, istenmedikçe '
      + 'ikinci bir versiyon üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      + 'bilgiler ve aynı işlevler kalsın, hiçbirini atma — ama düzen, '
      + 'hiyerarşi, ızgara, gezinme ve sayfa ritmi tamamen senin '
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: Apple\'ın tanıtım sayfalarındaki gibi bir **bento** dili. '
      ...
      + 'olsun, kendi renkli yuvarlak zemininin içinde otursun. '
      + 'Gradyan, doku, çerçeve ve sert gölge yok; his temiz, ferah ve '
      + 'tertipli olsun. Yerleşimi gerçek bir bento ızgarası olarak '
      + 'kur: eşit sütunlu sıralar yerine farklı boyutlarda döşemeler — '
      + 'biri iki sütun genişliğinde, biri iki satır yüksekliğinde, '
      + 'yanlarında küçük kareler. Gezinmeyi üstte yuvarlak bir ada '
      + '(pill) içinde topla. Her bölümün kendi bento ızgarası olsun; '
      + 'mobilde döşemeler tek sütuna inip önem sırasına göre dizilsin. '
      + '**Ekte hangi ekran varsa yalnız onu çiz:** yalnız mobil ekran '
      + 'görüntüsü gönderdiysem yalnız mobil tasarım üret, yalnız '
      + 'masaüstü gönderdiysem yalnız masaüstü üret, ikisini birden '
      + 'gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir ekran '
  ...
  { anahtar: 'gece', ad: 'Gece / Koyu Lüks', renk: '#c08457',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: pahalı bir '
      + 'karanlık arayüz — neon değil, sakin ve ağırbaşlı. Zemin '
      + 'neredeyse siyah, hafif sıcağa çalan mürekkep siyahı; kartlar '
      + 'zeminden yalnız bir-iki ton açık olsun ve gölge yerine **%8-10 '
      + 'saydamlıkta 1px açık kenarlıkla** ayrılsın. Tek metalik vurgu '
      + 'rengi kullan (bakır ya da şampanya) ve bu renk yalnız ana '
      + 'düğmede, aktif menü satırında ve tek bir rakamda görünsün. '
      + 'Metin kırık beyaz, ikincil metin sıcak gri olsun — saf beyaz '
      + 'kullanma, göz yorulmasın. Başlıklarda orta kalınlık ve hafif '
      + 'geniş harf aralığı; sayılar iri ama ince ağırlıkta. İkonlar '
      + 'ince çizgili ve vurgunun sönük hâlinde. Köşeler ölçülü '
      + '(10-12px). Parlama, neon, degrade ve camsı bulanıklık yok — '
      + 'derinlik yalnız ton farkından gelsin. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: pahalı bir karanlık arayüz — neon değil, sakin ve '
      ...
      + 'Yerleşimi sakin bir kontrol paneli gibi kur: solda yalnız ikon '
      ...
      + 'sağında dar bir özet sütunu dursun. **Ekte hangi ekran varsa '
      + 'yalnız onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem '
      + 'yalnız mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
  ...
  { anahtar: 'sakin', ad: 'Sakin / Serin Pastel', renk: '#4e8c79',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: serin, ferah ve '
      + 'sakinleştirici bir arayüz — sağlık uygulamalarının dili ama '
      + 'kurumsal ciddiyette. Palet tamamen serin ve soluk: nane, '
      + 'adaçayı, buz mavisi, kırık beyaz; sıcak renk hiç kullanma. '
      + 'Zemin hafif renkli, kartlar saf beyaz ve **tamamen düz** olsun '
      + '— gölge yok, yalnız çok açık 1px kenarlık. Köşeler ölçülü '
      + 'yuvarlak (12-16px). Satır aralığını bol tut (1.7) ve her '
      + 'bölümün çevresinde geniş boşluk bırak; hiçbir yer sıkışmasın. '
      + 'Yazı tipi yumuşak uçlu geometrik bir sans olsun, başlıklarda '
      + 'en fazla orta kalınlık — ağır/black ağırlık kullanma. Durum '
      + 'rozetleri pastel zeminli ve koyu yazılı olsun, doygun renk '
      + 'kullanma. İkonlar ince çizgili ve yuvarlak uçlu. Hiçbir yerde '
      + 'degrade, doku, gölge ya da canlı renk olmasın. **Ekte hangi '
      + 'ekran varsa yalnız onu çiz:** yalnız mobil ekran görüntüsü '
      + 'gönderdiysem yalnız mobil tasarım üret, yalnız masaüstü '
      + 'gönderdiysem yalnız masaüstü üret, ikisini birden gönderdiysem '
      + 'ikisini ayrı ayrı çiz. Ekte olmayan bir ekran türünü '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: serin, ferah ve sakinleştirici bir arayüz — sağlık '
      + 'uygulamalarının dili ama kurumsal ciddiyette. Palet tamamen '
      ...
      + 'renk olmasın. Yerleşimi nefes alan tek bir dikey akış olarak '
      + 'kur: dar bir içerik genişliği, bölümler arasında geniş '
      + 'boşluklar ve her bölümde tek bir iş. Gezinme üstte sade ve '
      + 'yalnız yazıyla, mobilde altta yumuşak bir çubuk olsun. '
      + 'Sayıları yan yana üç sakin kart hâlinde ver; liste satırlarını '
      + 'çizgiyle değil boşlukla ayır. **Ekte hangi ekran varsa yalnız '
      + 'onu çiz:** yalnız mobil ekran görüntüsü gönderdiysem yalnız '
      + 'mobil tasarım üret, yalnız masaüstü gönderdiysem yalnız '
      + 'masaüstü üret, ikisini birden gönderdiysem ikisini ayrı ayrı '
      + 'çiz. Ekte olmayan bir ekran türünü kendiliğinden ekleme, '
      + 'istenmedikçe ikinci bir versiyon üretme. Mobil çizeceksen '
      + 'masaüstünü daraltarak verme, mobil yerleşimi baştan düşün.' },
  { anahtar: 'terra', ad: 'Toprak / Sıcak Nötr', renk: '#7a8450',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: sıcak toprak '
      + 'tonlarıyla kurulmuş, olgun ve sakin bir modern arayüz — el '
      + 'yapımı ya da rustik değil, temiz ve çağdaş. Palet: kum, kil, '
      + 'kavrulmuş toprak, zeytin yeşili ve koyu kahve. Beyaz yerine '
      + 'kırık krem kullan, saf siyah hiç kullanma. Zemin kumlu bir '
      + 'nötr, kartlar bir ton daha açık olsun; ayrımı gölgeyle değil '
      + 'ince kenarlık ve ton farkıyla yap. Vurgu rengi zeytin ya da '
      + 'terracotta olsun ve yalnız düğmelerde ve aktif durumda '
      + 'görünsün. Köşeler cömertçe yuvarlak (16px) ama abartısız. '
      + 'Fotoğraf kullanılacaksa doğal ışıklı, düşük doygunlukta ve '
      + 'sıcak tonlu olsun. Yazı tipi açık ve yuvarlak harfli humanist '
      + 'bir sans; istersen başlıklarda ince bir serifle ikili kur. '
      + 'Gölge, parlaklık, degrade ve doygun renk yok. **Ekte hangi '
      + 'ekran varsa yalnız onu çiz:** yalnız mobil ekran görüntüsü '
      + 'gönderdiysem yalnız mobil tasarım üret, yalnız masaüstü '
      + 'gönderdiysem yalnız masaüstü üret, ikisini birden gönderdiysem '
      + 'ikisini ayrı ayrı çiz. Ekte olmayan bir ekran türünü '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: sıcak toprak tonlarıyla kurulmuş, olgun ve sakin bir '
      ...
      + 'yok. Yerleşimi geniş ve ferah kur: en üstte tam genişlikte '
      + 'sıcak tonlu bir görsel şerit ve üstünde tek bir başlık, '
      + 'altında ikişerli kart satırları. Menü üstte yatay ve yazıyla '
      + 'dursun; bölümleri ince kum rengi çizgilerle ayır. Sayfayı '
      + 'geniş, koyu toprak renkli bir alt bilgi bloğuyla bitir. **Ekte '
      + 'hangi ekran varsa yalnız onu çiz:** yalnız mobil ekran '
      + 'görüntüsü gönderdiysem yalnız mobil tasarım üret, yalnız '
      + 'masaüstü gönderdiysem yalnız masaüstü üret, ikisini birden '
      + 'gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir ekran '
      + 'türünü kendiliğinden ekleme, istenmedikçe ikinci bir versiyon '
  ...
  { anahtar: 'veri', ad: 'Veri Gazetesi / Grafik Öncelikli', renk: '#1b6e8c',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: ciddi bir '
      + 'gazetenin veri servisi — sayının kendisi değil, **anlamı** öne '
      + 'çıksın. İkili tipografi kur: manşet ve başlıklar klasik bir '
      + 'serif, etiketler ve sayılar küçük bir sans. Zemin çok açık '
      + 'soğuk gri, kartlar beyaz; ayrım için gölge değil 1px açık '
      + 'kenarlık ve ince yatay cetvel çizgileri kullan, köşeler '
      + 'neredeyse keskin (4px). Her sayının yanında küçük bir eğilim '
      + 'grafiği (sparkline) ya da yatay çubuk olsun. Tek koyu petrol '
      + 'mavisi vurgu rengi kullan; iyi/kötü ayrımını kırmızı-yeşil '
      + 'yerine **koyu mavi ve kiremit** ile yap. Önemli rakamların '
      + 'yanına kısa açıklama notları ve ince ok işaretleri koy (ör. '
      + '\'geçen aya göre iki katı\'). Grafiklerde eksen çizgileri çok '
      + 'soluk, veri çizgileri kalın olsun. Süs, gölge, degrade ve ikon '
      + 'kalabalığı yok. **Ekte hangi ekran varsa yalnız onu çiz:** '
      + 'yalnız mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım '
      + 'üret, yalnız masaüstü gönderdiysem yalnız masaüstü üret, '
      + 'ikisini birden gönderdiysem ikisini ayrı ayrı çiz. Ekte '
      + 'olmayan bir ekran türünü kendiliğinden ekleme, istenmedikçe '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: ciddi bir gazetenin veri servisi — sayının kendisi değil, '
      ...
      + 'degrade ve ikon kalabalığı yok. Yerleşimi bir veri makalesi '
      + 'gibi kur: üstte tek cümlelik iri serif bir manşet, hemen '
      + 'altında ana grafiğin tam genişlikte hâli, sonra iki-üç sütunlu '
      + 'küçük grafik ızgarası, en altta ayrıntılı tablo. Menü üstte '
      + 'ince bir şeritte, bölüm bağlantıları yan yana dursun. '
      + 'Grafiklerin sağında dar bir açıklama sütunu bırak. **Ekte '
      + 'hangi ekran varsa yalnız onu çiz:** yalnız mobil ekran '
      + 'görüntüsü gönderdiysem yalnız mobil tasarım üret, yalnız '
      + 'masaüstü gönderdiysem yalnız masaüstü üret, ikisini birden '
      + 'gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir ekran '
  ...
  { anahtar: 'canli', ad: 'Canlı Blok / Yüksek Kontrast', renk: '#2b4ee6',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: cesur, doygun '
      + 'renk bloklarıyla kurulmuş çağdaş bir ürün sitesi (modern '
      + 'fintek uygulamalarının dili). Zemin nötr olmasın — koyu ve '
      + 'doygun tek bir ana renk (elektrik kobalt) bütün sayfayı '
      + 'kaplasın; kartlar bu rengin bir ton koyusu olsun ve '
      + 'üzerlerindeki yazı beyaz kalsın. Yalnız bir-iki blok saf beyaz '
      + 'zeminli olup koyu yazı taşısın — bu bloklar sayfanın en önemli '
      + 'yerleri olsun. İkinci renk olarak **tam zıt, çok parlak bir '
      + 'vurgu** seç (limon/asit yeşili) ve yalnız ana düğmede, aktif '
      + 'menü satırında ve tek bir rakamda kullan. Başlıklar çok iri ve '
      + 'ağır (black/extrabold), harf araları sıkı olsun; gövde yazısı '
      + 'normal kalınlıkta ve küçük kalsın — kontrast tamamen ölçek '
      + 'farkından gelsin. İkincil yazılar rengin açık tonu olsun, gri '
      + 'kullanma; hiçbir yerde okunmayan soluk gri kalmasın. Gölge, '
      + 'degrade, kenarlık ve doku kullanma, her şey düz renk. Köşeler '
      + 'yumuşak (14-18px) ama kart içindeki hizalar keskin. İkonlar '
      + 'dolu ve kalın. **Ekte hangi ekran varsa yalnız onu çiz:** '
      + 'yalnız mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım '
      + 'üret, yalnız masaüstü gönderdiysem yalnız masaüstü üret, '
      + 'ikisini birden gönderdiysem ikisini ayrı ayrı çiz. Ekte '
      + 'olmayan bir ekran türünü kendiliğinden ekleme, istenmedikçe '
    ...
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: cesur, doygun renk bloklarıyla kurulmuş çağdaş bir ürün '
      ...
      + 'keskin. İkonlar dolu ve kalın. Yerleşimi tam genişlikte renk '
      + 'şeritlerinin ardı ardına gelmesiyle kur: üstte renk bloğunun '
      + 'içinde duran sade bir menü, altında ekranın yarısını kaplayan '
      + 'iri bir manşet ve tek bir ana düğme; sonra beyaz bir blok, '
      + 'sonra yeniden renkli blok. Sayılar renkli şeritlerin üstünde '
      + 'az sayıda ve çok büyük dursun; uzun listeler beyaz bloklarda '
      + 'toplansın. **Ekte hangi ekran varsa yalnız onu çiz:** yalnız '
      + 'mobil ekran görüntüsü gönderdiysem yalnız mobil tasarım üret, '
      + 'yalnız masaüstü gönderdiysem yalnız masaüstü üret, ikisini '
      + 'birden gönderdiysem ikisini ayrı ayrı çiz. Ekte olmayan bir '
      + 'ekran türünü kendiliğinden ekleme, istenmedikçe ikinci bir '
  ...
  { anahtar: 'sinema', ad: 'Sinema / Geniş Perde', renk: '#4fb0ab',
    ...
    prompt: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. İçeriği, kartları, menüyü ve yerleşimi '
      + 'olduğu gibi koru; hiçbir öğeyi ekleme, çıkarma ya da yerini '
      + 'değiştirme — yalnız görsel dili değiştir. Yön: sinematik renk '
      + 'verme (color grading) — bir film tanıtım sitesi gibi. Zemin '
      + 'koyu kömür olsun, saf siyah değil. Görselleri tam taşan (full- '
      + 'bleed) ve geniş oranlı kullan, üstlerine alttan yukarı '
      + 'koyulaşan bir perde koy ki yazı okunsun. Renk verme soğuk- '
      + 'sıcak zıtlığı üzerine kurulsun: gölgeler turkuaza, ışıklar '
      + 'kehribara çalsın; bu iki renk dışında renk kullanma. '
      + 'Başlıkları **ince (light) ağırlıkta ama çok iri** yaz, harf '
      + 'araları geniş, gerekirse tamamı büyük harf; gövde yazısı küçük '
      + 've soluk kalsın. Kartların köşeleri neredeyse keskin (4px), '
      + 'kenarlık çok soluk, gölge yok. Görsellerin üstüne ince '
      + 'çizgiyle çerçevelenmiş küçük altyazı kutuları koy. Bütün '
      + 'sayfaya çok hafif bir film greni bindir. Parlak, doygun ya da '
      + 'neon hiçbir renk olmasın. **Ekte hangi ekran varsa yalnız onu '
      + 'çiz:** yalnız mobil ekran görüntüsü gönderdiysem yalnız mobil '
      + 'tasarım üret, yalnız masaüstü gönderdiysem yalnız masaüstü '
      + 'üret, ikisini birden gönderdiysem ikisini ayrı ayrı çiz. Ekte '
      + 'olmayan bir ekran türünü kendiliğinden ekleme, istenmedikçe '
      + 'ikinci bir versiyon üretme.',
    promptYeniden: 'Ekte gönderdiğim ekran görüntüsü/görüntüleri {FIRMA}\'nin '
      + 'gerçek uygulaması. Bu sefer **yerleşimi de yeniden kur**: aynı '
      ...
      + 'kararın. Bunu bir tasarım ajansının {SEKTOR} uygun biçimde '
      + 'sıfırdan kurguladığı çağdaş bir web uygulaması gibi düşün. '
      + 'Yön: sinematik renk verme (color grading) — bir film tanıtım '
      ...
      + 'Parlak, doygun ya da neon hiçbir renk olmasın. Yerleşimi geniş '
      + 'perde ritminde kur: en üstte ekranın yüksekliğini kaplayan tam '
      + 'taşan bir görsel ve üstünde ortalanmış ince iri başlık; aşağı '
      + 'indikçe tam genişlikte görsel şeritlerle dar metin blokları '
      + 'sırayla gelsin. Menü en üstte saydam ve ince olsun, sayfa '
      + 'kaydıkça koyulaşsın. Sayıları görselin üstünde, altyazı '
      + 'kutuları gibi göster. **Ekte hangi ekran varsa yalnız onu '
      + 'çiz:** yalnız mobil ekran görüntüsü gönderdiysem yalnız mobil '
      + 'tasarım üret, yalnız masaüstü gönderdiysem yalnız masaüstü '
      + 'üret, ikisini birden gönderdiysem ikisini ayrı ayrı çiz. Ekte '
      + 'olmayan bir ekran türünü kendiliğinden ekleme, istenmedikçe '
      + 'ikinci bir versiyon üretme. Mobil çizeceksen masaüstünü '
